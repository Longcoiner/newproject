...
function MenuLeft (){
    return(
        ...
        <div className="left-sidebar">
          ...
          <div className="brands_products">{/*Account*/}
            <h2>Account</h2>
            <div className="brands-name">
              <ul className="nav nav-pills nav-stacked">
                <li><a href> <span className="pull-right"><i className="fa fa-plus" /></span>Account</a></li>
                <li><Link to="/user/add-product"> <span className="pull-right"><i className="fa fa-plus" /></span>MY PRODUCT</Link></li>
              </ul>
            </div>
          </div>{/*/Account*/}
